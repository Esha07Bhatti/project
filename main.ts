...
let personalName : string = "Esha Bhatti";

let message :string = `Hello ${personalName}, Would you like to learn some python today? `;
...
let nameCase : string = "Esha Bhatti";
//  first step to upper case
let uppercaseName: string = nameCase.toUpperCase();

console.log(uppercaseName);

//  second step to lower case

let LowercaseName: string = nameCase.toLowerCase();

console.log(LowercaseName);

//  third step to title case

let worlds: string[] = nameCase.split(" ");

let tiltecaseName : string = " "
...
let Message : string = `Did you know that "${famous_person}" was a renowned physicist and mathematician?`;
...
let favorite_number = 8; // store favorite number.
console.log(`the author's favorite number is : ${favorite_number}`); // print the message with favorite number.

console.log("\nExercise # 9:");
//9. Names: Store the names of a few of your friends in a array called names. 
//Print each person’s name by accessing each element in the list, one at a time.

let names = ['Ammara', 'Saba', 'Sadia', 'Laiba', 'Maryam'];
...
let friends: string[] = ['Ammara', 'Saba', 'Sadia', 'Laiba', 'Maryam'];

// Define the message
let messages: string = "Hello, {name}! How are you.";
...
let transportations = ['motorcycle','car', 'bus', 'bicycle'];
...
let guestList : string[] = ["Zarlish", 'Sadia',"Saba"];

let invetedMessage :string = "Hello Dear {Guest}, I would you like to invite for dinner tonight."
...
let guest_List: string[] = ["Zarlish" , "Saba", "Sadia"];

let invitationMessage :string = "Hello {guest}, I would like to invite to dinner tonight."
...
let cantMakeIt:string = guest_List[2];

console.log("\n unfortunately ," + guest_List + "can't make it for dinner.\n");

let newGuest: string = "Ammara";
...
let GuestList: string[] = ["Zarlish" , "Saba", "Sadia"];
...
let invitationMessages : string = "Hello {guest}, I would like to  invited for a dinner tonight.";
...
for(let Rivers of riversOfPakistan){
    console.log(Rivers);
};
...
let FriendsNames: string[] = ["Asma", "Bushra", "Zahid", "Daniyal", "Eman"];
...
// Define an array of friends' names
let FriendsName: string[] = ["Asma", "Bushra", "Zahid", "Daniyal", "Eman"];
...
let usernames: string[] = ['admin', 'Eshan', 'hafeez', 'zeeshan', 'asif'];
...
let current_users:string[] = ['Esha','Sumera','Maria','Fatima','Faiza'];
let new_users:string[] = ['Umar','Sumera','Asad','Faiza','Fariya'];

for(let new_user of new_users){
    let newuserExits = false;
    for(let current_user of current_users){
        if(new_user.toLowerCase() === current_user.toLowerCase()){
            let newuserExits = true;
            break;
        }
    }
    if(newuserExits){
        console.log(`sorry! the username "${new_user}" is already Exits. Please Enter another username.`);
    } else{
...
let Fav_Pizzas: string[] = ['Fajita' , 'BBQ chicken' , 'spicy Beef'];
...
let animals:string[] = ['Dog' , 'Brids' , 'Cat'];
...
let magicianNames: string[] = ['alice', 'david', 'carolina'];
...
let magiciansNames: string[] = ["David Copperfield", "Harry Houdini", "Penn Jillette", "Teller"];
